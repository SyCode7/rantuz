 ...
 *       &lt;sequence>
 *         &lt;element ref="{}cert_ref" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "cert_refs")
public class CertRefs {

    @XmlElement(name = "cert_ref")
    protected List<CertRef> certRef;
     ...
     * 
     */
    public List<CertRef> getCertRef() {
        if (certRef == null) {
            certRef = new ArrayList<CertRef>();
        }
        return this.certRef;
    }
